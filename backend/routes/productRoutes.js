...
const { addProduct, getAllProducts, deleteProduct, updateProduct } = require('../controllers/productControllers')
...
router.route('/products/:id').delete(deleteProduct).put(upload.single('image'), updateProduct)
